...
${OBJECTDIR}/lib/src/comgui.o: lib/src/comgui.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/src/comgui.o lib/src/comgui.cpp

${OBJECTDIR}/lib/src/comstm32.o: lib/src/comstm32.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/src/comstm32.o lib/src/comstm32.cpp

${OBJECTDIR}/lib/src/control.o: lib/src/control.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/src/control.o lib/src/control.cpp

${OBJECTDIR}/lib/src/messages.o: lib/src/messages.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/src/messages.o lib/src/messages.cpp

${OBJECTDIR}/lib/src/parameters.o: lib/src/parameters.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/src/parameters.o lib/src/parameters.cpp

${OBJECTDIR}/lib/src/trace.o: lib/src/trace.cpp
	${MKDIR} -p ${OBJECTDIR}/lib/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/src/trace.o lib/src/trace.cpp
