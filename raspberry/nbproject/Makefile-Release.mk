...
${OBJECTDIR}/lib/comgui.o: lib/comgui.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/comgui.o lib/comgui.cpp

${OBJECTDIR}/lib/comstm32.o: lib/comstm32.cpp
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/comstm32.o lib/comstm32.cpp
...
${OBJECTDIR}/lib/trace.o: lib/trace.cpp
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/trace.o lib/trace.cpp
...
${OBJECTDIR}/wrapper.o: wrapper.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wrapper.o wrapper.c
