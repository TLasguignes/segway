/**
  ...
  * @version V1.0 
  * @date    13-Juin-2017 
  * @brief   Fonctions utilis� pour interruptions
  ******************************************************************************
*/
...
float Anglemesure = 0.0f;													// variable de l'angle fusionn�
...
int cmpt_arr = 0 ;																//	variable de compteur pour reinitialiser �tat de arret de syst�me 
int arret = 0;																		//	variable de l'�tat arr�t urgence declecnh� par Raspberry Pi 
...
/**
  * @brief  Traitement donn�es de Gyro, Accelero et ADC
  * @param   
  * @retval  
  */
void Trait_Gyro_Acc (void) {
	...
	/* 
		* Remis de l'�tat arret urgence 
		*	La detection de arret urgence est fait dans interruption de USART reception	
		* Si STM ne re�oit pas de trame arr�t pendant 3 secondes (300 it�ration car frenquence de envoie de trame par RPI = 100Hz)
	...
	*/
	...
	/* Envoie de donn�e par USART dans le forme suivante*/
	...
	//	Limitation de 180.0 deg � -180.0 deg
...
/**
  * @brief  Fonction de convetir en bytes � float (pour reception de donn�e)
  * @param  None
  * @retval None
  */
